...
max_iters = 5000  # training cycles
eval_interval = 500  # how many chars generated when sampling
learning_rate = 3e-4
...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.ln_f = LayerNorm1d(n_embd)  # final layer norm
...
class LayerNorm1d:
    ...
    # Now normalizes across the rows insted of the columns
    # We use this normalization before out self attatntion layer and feed forward
